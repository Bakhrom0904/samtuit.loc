    ...
    <div class="container pt-60 pb-60">
        ...
        <div class="section-content">
            <div class="col-md-12 text-center">
                <h2 class="title text-white newevent"><?=Yii::t("app","E`lonlar");?></h2>
                <ul class="text-center text-black mt-10">
                    <li><a href="/" class="text-white"><?=Yii::t("app","Bosh sahifa");?></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="/elonlar/list" class="text-white"><i class="fa fa-angle-right">&nbsp;</i><?=Yii::t("app","Yangiliklar");?></a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    ...
                                    <div class="project-details p-15 pt-10 pb-10">
                                        ...
                                        <p><?=$elon->$til;?></p>
                                        <div class="mt-10"> <a href="/elonlar/view?id=<?=$elon->id;?>" class="btn btn-theme-colored btn-sm"><?=Yii::t("app","Batafsil");?></a> </div>
